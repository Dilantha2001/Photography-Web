          ...
          <div className="flex flex-col lg:flex-row items-center border-gray-300 gap-6 lg:gap-10">
            ...
            <div className="text-center lg:text-left">
              ...
              <p className="w-full md:max-w-[600px] font-noto-serif font-light text-gray-500 px-4 leading-relaxed">
                ...
                Rooted in documenting your love story with intention, emotion,
                and refined storytelling, I create imagery that reflects the
                depth of your experience—honest, beautiful, and completely your
                own.
              </p>
            </div>
          </div>
